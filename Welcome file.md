...
In this task we are going to explore several other objects of ase library generating atomic structures based on the terms as Bravais lattice, crystal, bulk, ...
